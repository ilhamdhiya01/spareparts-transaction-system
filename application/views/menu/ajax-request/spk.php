...
<div class="invoice p-5 mb-3">
    <div class="container">
        ...
        <center>
            <button id="cetak-spk" data-idservice="<?= $detail_data_service['id_service']; ?>" data-idpelanggan="<?= $detail_data_service['id_pelanggan']; ?>" class="btn btn-default"><i class="fas fa-print"></i> Cetak</button>
        </center>
    </div>
</div>
<script>
    $("#cetak-spk").click(function() {
        $.ajax({
