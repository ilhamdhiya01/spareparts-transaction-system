                            ...
                            <tr class="text-sm">
                                <td width="5%" class="text-center">
                                    <div class="form-check">
                                        <input class="form-check-input position-static change-spareparts" <?= change_spareparts_checked($id_pelanggan, $sub_spareparts['id']); ?> data-idsubspareparts="<?= $sub_spareparts['id'] ?>" data-idspareparts="<?= $sub_spareparts['id_spareparts']; ?>" data-idpelanggan="<?= $id_pelanggan; ?>" data-idservice="<?= $id_service['id']; ?>" data-idmobil="<?= $id_mobil['id'] ?>" type="checkbox" id="blankCheckbox" value="option1" aria-label="...">
                                    </div>
                                </td>
                                <!-- <td width="1%"></td> -->
