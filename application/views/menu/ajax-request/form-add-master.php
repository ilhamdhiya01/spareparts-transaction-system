<form action="" id="form-add-master">
	<div class="form-group">
		<label for="nama_service">Service</label>
		<input type="text" class="form-control" value="" name="nama_service" id="nama_service">
...
<script>
	$('#form-add-master').submit(function (e) {
		$.ajax({
			url: '<?= base_url() ?>master/add_master',
			type: 'post',
			data: $(this).serialize(),
			dataType: 'json',
			success: (data) => {
