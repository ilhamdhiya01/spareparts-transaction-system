		...
		<div class="card card-info card-outline" id="card-spareparts">
			<div class="card-header">
				...
				<div class="card-tools">
					<a href="#" class="btn btn-tool hapus-sub-spareparts" title="Hapus Spareparts"
						data-idjenis="<?= $spareparts['id']; ?>">
						<i class="fas fa-trash"></i>
					</a>
					<a href="#" class="btn btn-tool tambah-sub-spareparts" title="Tambah Spareparts"
						data-idjenis="<?= $spareparts['id']; ?>" data-toggle="modal" data-target="#modal-form-sub">
				...
				<table class="table table-striped table-bordered table-sm" id="tab3">
					...
					<tbody>
						...
						<tr id="li-sub-spareparts">
							...
							<td class="text-center"><i class="fas fa-times hapus-sub-spare"
									data-idsub="<?= $sub['id']; ?>" title="Hapus"></i></td>
							<td class="text-center"><i class="fas fa-pencil-alt ubah-sub-spareparts"
									data-idjenis="<?= $spareparts['id']; ?>" data-idsub="<?= $sub['id']; ?>"
									data-toggle="modal" data-target="#modal-form-sub" title="Ubah"></i></td>
						</tr>
						<?php endforeach; ?>
					</tbody>
				</table>
...
<script>
	...
	$(".hapus-sub-spare").click(function () {
