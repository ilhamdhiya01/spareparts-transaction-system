...
<section class="content">
	<div class="container-fluid">
		<div class="btn-sub-menu">
			<ul>
				<li><a href="#" data-toggle="modal" data-target="#tambah-sub-menu" class="btn btn-primary btn-sm"
						id="modal-tambah-sub-menu"><i class="fa fa-plus-square"></i> Tambah Sub Menu</a></li>
				<li><a href="<?= base_url(); ?>menu/dropdown_subMenu" class="btn btn-light btn-sm"><i
...
<script>
	...
	$('#modal-tambah-sub-menu').click(function () {
		$.get('<?= base_url() ?>menu/formSubMenu', function (data) {
